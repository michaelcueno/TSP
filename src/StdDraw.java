 ...
 */
public final class StdDraw extends Applet implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static JMenuBar createMenuBar() {
        ...
        JMenuItem menuItem2 = new JMenuItem(" Done, run TSP ");
        menuItem1.addActionListener(std);
        menuItem1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
                                Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
        //menuItem1.setActionListener((ActionListener)EventHandler.create(ActionListener.class, std, "doneRunTsp"));
        menu.add(menuItem1);
        menu.add(menuItem2);
        return menuBar;
    }
    ...
    *************************************************************************/
    ...
    /**
     * Get points from user (from clicks)
     */
    public static void getInputPoints() {
